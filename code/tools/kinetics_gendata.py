...
def gendata(
    ...
    sample_name = sample_name[: int(0.3 * len(sample_name))]
    sample_label = []

    fp = np.zeros(
        (len(sample_name), 3, max_frame, num_joint, num_person_out), dtype=np.float32
    )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", default="../datasets/kinetics-skeleton")
    parser.add_argument("--out_folder", default="./kinetics_data/")
